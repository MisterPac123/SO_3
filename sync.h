...
#include "constants.h"
    ...
    #define syncMech_trylock(a)  pthread_rwlock_trywrlock(a)
#elif MUTEX
    ...
    #define syncMech_trylock(a)  pthread_mutex_trylock(a)
    ...
    #define syncMech_trylock(a)  do_nothing(a)
#endif
...
void semaphore_init(sem_t* sem, int n);
